...
# manual-linux.sh
#
# Automates the creation of a minimal ARM64 Linux system for QEMU.
#
# The script downloads and builds the Linux kernel and BusyBox, creates a
# root filesystem, installs required shared libraries and device nodes,
# cross-compiles the finder application, and generates a compressed initramfs.
#
# The resulting artifacts include an ARM64 kernel image and a bootable
# BusyBox-based userspace suitable for execution under QEMU.
#
#
# Usage:
