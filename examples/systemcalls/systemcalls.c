/**
 * @file systemcalls.c
 * @brief Utility functions for executing external commands.
 *
 * Provides wrapper functions around system(), fork(), execv(), and waitpid()
 * to execute commands and optionally redirect command output to a file.
 *
