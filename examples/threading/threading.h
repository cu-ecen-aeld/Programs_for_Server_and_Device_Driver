/**
 * @file threading.h
 * @brief Interfaces and data structures for thread synchronization utilities.
 *
 * Defines the thread_data structure and provides an interface for
 * creating threads that acquire and release a mutex after configurable
 * delays. These utilities demonstrate basic POSIX thread synchronization.
 *
